...
$resultArray = array();
  ...
  $conn=$db->conn;
  $sql="SELECT EvTime,".$_point." FROM datahru".$_GET['mmunit']." WHERE EvTime BETWEEN '".$_GET['starttime']."' and '".$_GET['endtime']."'";
...
//http://localhost/public/webservice/createJsonFileHru.php?starttime=2014-05-01%2000:00:00&endtime=2014-05-01%2001:00:00&mmunit=04&point=D19,D999&_unit=1
?>
