...
rtdata8.tagatom NOT LIKE 'OUT%' AND
rtdata8.tagatom NOT LIKE 'DRM%' AND
rtdata8.tagatom NOT LIKE 'FNP%' AND
rtdata8.tagatom NOT LIKE 'LP%' AND
rtdata8.tagatom NOT LIKE 'QA%' AND
rtdata8.tagatom NOT LIKE 'SAME%' AND
rtdata8.tagatom NOT LIKE 'LO%' AND
rtdata8.tagatom NOT LIKE 'SG31T05%' AND
rtdata8.tagatom NOT LIKE 'LS%' AND
rtdata8.tagatom NOT LIKE 'LHV%' AND
